...
import '../../pages/student_profile/my_profile_widget.dart';
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          requireAuth: true,
          asyncParams: {
            'studentdatapage': getDoc(['Student'], StudentRecord.fromSnapshot),
            'coursedatastudent':
                getDoc(['Student', 'Courses'], CoursesRecord.fromSnapshot),
          },
          builder: (context, params) => HomeWidget(
            studentdatapage: params.getParam(
              'studentdatapage',
              ParamType.Document,
            ),
            coursedatastudent: params.getParam(
              'coursedatastudent',
              ParamType.Document,
            ),
          ),
